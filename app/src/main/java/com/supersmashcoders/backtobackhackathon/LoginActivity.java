...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url ="http://www.backcountry.com/images/bcs/bc-logo.png";
        final ImageView bcLogo = (ImageView) findViewById(R.id.bcLogo);
        imageProxy.getURLImage(this, url, bcLogo);
    }
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                userProxy.validateUser(null, mEmail, mPassword, new RequestListener<UserModel>() {
                    ...
                    @Override
                    public void onError() {
                        Log.e("API CALL", "Error validating user");
                    }
                });
